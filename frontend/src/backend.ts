...
export class Backend implements backendInterface {
    ...
    async addRandomPointsToRoom(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addRandomPointsToRoom(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async onSnakeDeath(arg0: string, arg1: Array<Coordinate>, arg2: bigint): Promise<Array<CoinDrop>> {
        if (this.processError) {
            try {
                const result = await this.actor.onSnakeDeath(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
