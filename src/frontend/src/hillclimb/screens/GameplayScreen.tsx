...
import { createVehicle, updateVehicle, type Vehicle } from '../engine/vehicle';
...
export default function GameplayScreen({ vehicleId, stageId, upgradeLevels, onRunEnd }: GameplayScreenProps) {
  ...
  useEffect(() => {
    ...
    vehicleRef.current = createVehicle(upgradedStats);
    terrainRef.current = createTerrain(stage.terrainConfig);
  ...
  const step = (dt: number) => {
    ...
    updatePickups(pickups, vehicle.position.x);
